                ...
                <form className="flex flex-col mt-6">
                   ...
                   {customers.length !== 0 && (
                    <>
                        ...
                        <select className="w-full border-2 rounded-md px-2 mb-2 h-11 resize-none bg-white cursor-pointer">
                   ...
                   {customers.length === 0 && (
                    <Link href="/dashboard/customer/new">
                        Você ainda não tem nenhum cliente cadastrado. <span className="text-blue-500 font-medium">Clique aqui</span>
                    </Link>
                   )}
                    <button 
                    type="submit" 
